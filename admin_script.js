// ==========================================================
// Archivo: admin_script.js - CORREGIDO FINAL (ÁMBITO/SCOPE DE FUNCIONES)
// ==========================================================
...
let adminView; // Declarar adminView a nivel global para que todas las funciones puedan usarlo
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    supabase.auth.onAuthStateChange((event, session) => {
        if (event === 'SIGNED_IN' || session) {
            ...
            // Llama a la función principal de inicialización de la interfaz
            inicializarInterfazAdmin(session.user);
        } else {
...
// =================================================================
// FUNCIÓN PRINCIPAL: CONTENEDOR DE LA INICIALIZACIÓN DE LISTENERS
// =================================================================

function inicializarInterfazAdmin(user) {
    console.log("Panel cargado para:", user.email);

    // Evitar inicializar los listeners múltiples veces (ya que onAuthStateChange puede dispararse varias veces)
...
// =================================================================
// A. GESTIÓN DE SORTEOS (Funciones a nivel global para ser visibles)
// =================================================================
...
// =================================================================
// B. GESTIÓN DE PAGOS (Funciones a nivel global)
// =================================================================
...
// --- FUNCIÓN PRINCIPAL: ASIGNAR NÚMEROS Y VALIDAR ORDEN (A nivel global) ---
